...
namespace SimoneChinaglia\Sentry\Controller\Adminhtml\Test;

use SimoneChinaglia\Sentry\Helper\Data;
use SimoneChinaglia\Sentry\Model\SentryLog;
use SimoneChinaglia\Sentry\Plugin\MonologPlugin;
...
class Sentry extends Action
{
     ...
     * @see _isAllowed()
     */
    const ADMIN_RESOURCE = 'SimoneChinaglia_Sentry::sentry';
    ...
    /**
     * @var SimoneChinaglia\Sentry\Model\SentryLog|SentryLog
     */
